...
set LIBRARY_LIST=GLFW SDL2 FREETYPE POGLIB
...
:build_project_with_msvc
    ...
    set INCLUDES=/I %LIBRARY_DEFAULT_PATH%\glad\include ^
    ...
    set LIBS=%LIBRARY_DEFAULT_PATH%\FREETYPE\lib\win64\freetype.lib ^
    ...
    %CC% %CC_DEFAULT_FLAGS% %FLAGS%^
        ...
        %SRC_FOLDER_DEFAULT_PATH%\%SRC_FILE_NAME% %LIBRARY_DEFAULT_PATH%\poglib\external\glad\src\glad.c ^
