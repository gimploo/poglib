...
int main(void)
{
    ...
    glcircle_t glcircle01 = glcircle_init(circle01, (vec4f_t ) {1.0f, 0.0f, 1.0f, 1.0f}, quadf_init(vec2f(0.0f), 1.0f, 1.0f), 0);
    glcircle_t glcircle02 = glcircle_init(circle02, (vec4f_t ) {1.0f, 0.0f, 1.0f, 1.0f}, quadf_init(vec2f(0.0f), 1.0f, 1.0f), 0);
