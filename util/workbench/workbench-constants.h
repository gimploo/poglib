...
typedef enum {
    ...
    PROTOTYPE_SPRITE_BASIC_WHITE            = 0,
    PROTOTYPE_SPRITE_BASIC_GRAY             = 1,
    PROTOTYPE_SPRITE_BASIC_DARK_GRAY        = 2,
    PROTOTYPE_SPRITE_BASIC_BLACK            = 3,
    PROTOTYPE_SPRITE_BASIC_RED              = 4,
    PROTOTYPE_SPRITE_BASIC_MAROON           = 5,
    PROTOTYPE_SPRITE_BASIC_ORANGE           = 6,
    PROTOTYPE_SPRITE_BASIC_BROWN            = 7,

    PROTOTYPE_SPRITE_CHECKERED_LIGHT_GRAY   = 19,
    PROTOTYPE_SPRITE_CHECKERED_DARK_GRAY    = 20,
    PROTOTYPE_SPRITE_DARK_GRAY              = 21,

    PROTOTYPE_SPRITE_YELLOW_T               = 24
...
typedef enum {
    ...
    PROTOTYPE_SPRITE_BASIC_BLACK            = 0,
    PROTOTYPE_SPRITE_CROSS_BLACK            = 1,
    PROTOTYPE_SPRITE_CHECKEREDx4_BLACK      = 6,
    PROTOTYPE_SPRITE_CHECKERED_BLACK        = 7,

    PROTOTYPE_SPRITE_BASIC_GREEN            = 13,
    PROTOTYPE_SPRITE_CHECKERED_GREEN        = 21,

    PROTOTYPE_SPRITE_BASIC_WHITE            = 26,
    PROTOTYPE_SPRITE_CHECKEREDx4_WHITE      = 31,
    PROTOTYPE_SPRITE_CHECKERED_WHITE        = 32,

    PROTOTYPE_SPRITE_BASIC_ORANGE           = 39,
    PROTOTYPE_SPRITE_CHECKERED_ORANGE       = 47,

    PROTOTYPE_SPRITE_BASIC_PURPLE           = 52,
    PROTOTYPE_SPRITE_CHECKERED_PURPLE       = 60,

    PROTOTYPE_SPRITE_BASIC_RED              = 65,
    PROTOTYPE_SPRITE_CHECKERED_RED          = 73,

    PROTOTYPE_SPRITE_CHECKERED_DARK_GRAY    = PROTOTYPE_SPRITE_CHECKEREDx4_WHITE,
    PROTOTYPE_SPRITE_CHECKERED_LIGHT_GRAY   = PROTOTYPE_SPRITE_CHECKEREDx4_BLACK,
} PROTOTYPE_TEXTURE_TYPE;
