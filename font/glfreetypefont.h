...
typedef struct glfreetypefont_t glfreetypefont_t ;

glfreetypefont_t    glfreetypefont_init(const char *filepath, const u32 fontsize);
void                glfreetypefont_set_text(glfreetypefont_t *self, const char *text, vec2f_t pos, vec4f_t color);
...
void glfreetypefont_destroy(glfreetypefont_t *self)
{
    ...
    glshader_destroy(self->renderer2d.__shader);
    free(self->renderer2d.__shader); self->renderer2d.__shader = NULL;
    gltexture2d_destroy(self->renderer2d.__texture);
    free(self->renderer2d.__texture); self->renderer2d.__texture = NULL;
